        ...
        <div className='grid grid-col-1 xl:grid-cols-3 gap-8 [&>*]:w-full h-fit [&>*]:h-full'>
          ...
          <section data-aos='fade-up' className='flex flex-col justify-between items-center [&>*]:border [&>*]:border-main-400 [&>*]:rounded-md [&>*]:text-main-600'>
            <article className='pt-6 pb-12 px-6 grow w-full flex flex-col justify-center items-center text-main-600 '>
              ...
              <p className='mb-6'>{contacts.find(item => item.type === 'Email')?.link}</p>
          ...
          <section data-aos='fade-up' className='flex flex-col justify-between items-center [&>*]:border [&>*]:border-main-400 [&>*]:rounded-md [&>*]:p-6 [&>*]:text-main-600'>
            <article className='mb-8'>
              ...
              <p className='mb-2'>I studied Multimedia and Communication Technologies at University of Aveiro. During the course I started my programing adventure. Since then, I've had the oportunity to work on a variety of projects with different clients which allowed me to grow my skillset as a fullstack web developer.
              </p>

              <p>
                Besides programming, I love fantasy books and have a special place in my heart for videogames. You might realize that through some of my projects.
              </p>
          ...
          <section data-aos='fade-up' className='flex flex-col items-center [&>*]:border [&>*]:border-main-400 [&>*]:rounded-md [&>*]:p-6 [&>*]:text-main-600'>
            <article className='mb-8'>
              <h1 className='text-main-700 mb-3'>Preferred Technologies</h1>
              <div className='flex flex-wrap gap-2'>
            ...
            <article className='flex flex-col justify-between grow bg-main-200'>
              <div>
                ...
                <p className='mb-6'>I am capable of working both independently and as part of a team. Altough my primary expertise is fullstack development I also do UI/UX design. My main goal is to help you build web applications that deliver the optimal user  experience, utilizing the cutting-edge technologies available in the market.
                </p>
              </div>
